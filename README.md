...
[<img alt="GitHub tag (with filter)" src="https://img.shields.io/github/v/tag/bendoerr-terraform-modules/terraform-aws-cloudfront-jwt-authz?filter=v*&label=latest%20tag&logo=terraform">](https://github.com/bendoerr-terraform-modules/terraform-aws-cloudfront-jwt-authz/tags)
...
| <a name="module_lambda"></a> [lambda](#module_lambda) | bendoerr-terraform-modules/lambda/aws | 0.4.0 |
